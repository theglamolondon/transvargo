...
@section('content')
    <section class="section section-inset-2 bg-light">
        <div class="container">
            ...
            <hr/>
            <p>Pour le transport de vos produits vous pouvez commander votre camion par téléphone au <a href="callto:55596855">55 596 855</a> ou en vous connectant directement  sur la plateforme.
    ...
    <section class="section section-inset-1" id="avantages">
        <div class="container">
            ...
            <p>Pour en savoir plus joignez le service commercial au <a href="callto:55596855">55 596 855</a></p>
